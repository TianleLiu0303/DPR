...
class DDPM_Sampler(torch.nn.Module):
    def __init__(
        ...
        super().__init__()
        self.num_steps = steps  # 扩散的总步数
        self.schedule = schedule  # 扩散调度方式
        self.clamp_val = clamp_val # 用于裁剪样本的值范围
    ...
    def q_mean(self,
        ...
        # 根据由噪声计算出来的x_0和当前样本x_t计算出前一个样本采样时候的均值
